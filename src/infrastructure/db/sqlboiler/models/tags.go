...
func (tagL) LoadPosts(ctx context.Context, e boil.ContextExecutor, singular bool, maybeTag interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.Select("\"posts\".\"id\", \"posts\".\"title\", \"posts\".\"content\", \"posts\".\"user_id\", \"posts\".\"status\", \"posts\".\"created_at\", \"posts\".\"updated_at\", \"posts\".\"first_published_at\", \"posts\".\"content_updated_at\", \"a\".\"tag_id\""),
		qm.From("\"posts\""),
	...
	for results.Next() {
		...
		err = results.Scan(&one.ID, &one.Title, &one.Content, &one.UserID, &one.Status, &one.CreatedAt, &one.UpdatedAt, &one.FirstPublishedAt, &one.ContentUpdatedAt, &localJoinCol)
		if err != nil {
...
func (o *Tag) AddPostsG(ctx context.Context, insert bool, related ...*Post) error {
...
// Uses the global database handle.
func (o *Tag) SetPostsG(ctx context.Context, insert bool, related ...*Post) error {
...
// Sets related.R.Tags.
// Uses the global database handle.
func (o *Tag) RemovePostsG(ctx context.Context, related ...*Post) error {
...
func FindTagG(ctx context.Context, iD string, selectCols ...string) (*Tag, error) {
...
func TagExistsG(ctx context.Context, iD string) (bool, error) {
